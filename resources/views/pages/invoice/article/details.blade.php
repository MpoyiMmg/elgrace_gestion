            ...
            <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a class="btn btn-outline-secondary btn-block mb-75" href="{{ route('articles.invoices.edit', $preInvoice->id) }}"> Modifier </a>
                        <a class="btn btn-success btn-block mb-75 waves-effect" href="{{ route('articles.invoices.print', $preInvoice->id) }}" target="_blank">Imprimer </a>
