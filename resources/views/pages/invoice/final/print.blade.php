    ...
    <div class="invoice-print p-5">
        <div class="d-flex justify-content-between">
            ...
            <div class="mt-md-0 mt-0">
                ...
                <!-- <h4 class="font-weight-bold text-right mb-1">Facture : {{ $invoice->reference }}</h4>
                <div class="invoice-date-wrapper mb-50">
                    <span class="invoice-date-title">Date:</span>
                    <span class="font-weight-bold"> {{ date('d/m/Y', strtotime($invoice->issue_date))}}</span>
                </div>
                <div class="invoice-date-wrapper">
                    <p class="invoice-date-title">Date d'échéance:</p>
                    <p class="invoice-date">{{ date('d/m/Y', strtotime($invoice->expiry_date))}}</p>
                </div> -->
            </div>
        </div>
        ...
        <div class="row text-center mt-2 mb-2">
            <div class="col-md-4 offset-md-4">
                <h3><b>INVOICE N° {{ $invoice->reference }}</b></h3>
            </div>
        </div>
        <div class="row pb-2 mt-2">
            ...
            <div class="col-sm-4">
                <p class="mb-2"><span class="font-weight-bolder">Livré à : </span><br>
                    {{ $invoice->preInvoice->client['name'] }} <br>
                    {{ $invoice->preInvoice->client['address'] }} <br>
                    {{ _('Lubumbashi')}}
                </p>
            </div>
            <div class="col-sm-4">
                <p class="mb-2"><span class="font-weight-bolder">Autres détails : </span><br>
                    {{ $invoice->preInvoice->client['phone'] }} <br>
                    {{ $invoice->preInvoice->client['email'] }}
                </p>
            </div>
        ...
        <div class="row mt-4">
            <div class="col-md-4 col-sm-4">
                <h5>Date: {{  date('d/m/Y', strtotime($invoice->preInvoice->created_at)) }}</h5>
            </div>
